<template>  
      <v-row>
          <v-col md="12">
              <button @click="handleCreate()" class="text-button"><v-icon>mdi-plus</v-icon>Create Quiz</button>
          </v-col>
          <v-col md="4">
                  ...
                  <v-row  >
                      ...
                      <v-col md="7">
                          <div class="px-4 text-right mt-5">
                              <button class="text-button" @click="handlePreview(quiz?.id)" style="background-color: #cddc39!important; border-color: #cddc39!important;">Preview</button>
                              <button class="text-button" style="background-color: #2196f3!important; border-color: #2196f3!important;">Report</button>
                          </div>
                      </v-col>
                  </v-row>
              </v-card>
