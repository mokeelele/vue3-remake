<template>
  ...
  ></v-select>
      ...
      <v-row>
        <v-col md="4" align="center" v-for="news in getNews?.data" :key="news.id">
            <v-card>
                ...
                <v-btn @click="handlePreview(news?.id)" outlined class="mb-5 mt-5 detail-button">More Details</v-btn>
            </v-card>
        </v-col>
      </v-row>
  </template>
